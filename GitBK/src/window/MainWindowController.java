...
import model.COGClass.COGMethod;
import model.COGElement;
import controller.GitCommandsController;
import facade.GitFacade;
import facade.HighlighterFacade;
import facade.HighlighterFacade.CodeType;
...
public class MainWindowController extends COGController {
    ...
    void onReadmeClicked() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/ReadmeWindow.fxml"));
    ...
    private void createChooseRepoWindow() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/ChooseRepoWindow.fxml"));
        Parent root = (Parent) loader.load();
        loader.<COGController>getController().setParentController(this);
